...
export default function Dashboard() {
  const { user, logout, triggerReAuth, handleReAuthSuccess, getTimeUntilLogout } = useAuthContext();
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-gradient-to-r from-canara-blue-50 to-canara-yellow-50 dark:from-canara-blue-900/20 dark:to-canara-yellow-900/20 border-b border-canara-blue-200 dark:border-canara-blue-800 px-4 py-1">
        ...
        <main className="flex-1 p-2 sm:p-4 max-w-7xl mx-auto w-full mt-0">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                        {isBalanceVisible ? `₹${totalBalance.toLocaleString('en-IN')}` : '••••••'}
                      </p>
                    </div>
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-canara-blue-100 dark:bg-canara-blue-900 rounded-lg flex items-center justify-center">
                      <IndianRupee className="w-5 h-5 sm:w-6 sm:h-6 text-canara-blue-600 dark:text-canara-blue-400" />
                    </div>
                  </div>
                </div>
